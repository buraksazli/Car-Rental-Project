...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      ...
      <h1>Edit Booking Informations</h1>
       ...
       <div class="container2">
        <div class="box">
          ...
          <input class="form-control" id="name" name="name" placeholder="Vehicle" type="text" required>
          ...
          <input class="form-control" id="name" name="name" placeholder="Payment" type="text" required>
          
          <a href="manager_bookings.php"><button class="btn" type="submit">Complete</button></a>
        </div>
