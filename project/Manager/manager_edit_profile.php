      ...
      <h1>Edit Profile</h1>
       ...
       <div class="container2">
        <div class="box">
          ...
          <span id="name-text">Branch</span>
          <input class="form-control" id="name" name="name" placeholder="Branch" type="text" required>
          <input type="file" name="fileToUpload" id="fileToUpload">  
          <a href="manager_page.php"><button class="btn" type="submit">Complete</button></a>
        </div>
