      ...
      <h1>Edit The Car</h1>
       ...
       <div class="container2">
        <div class="box">
            ...
            <input class="form-control" id="name" name="name" placeholder="Citroen" type="text" required>
            
            <span id="name-text">Price</span>
            <input class="form-control" id="name" name="name" placeholder="C3" type="text" required>
            ...
            <input class="form-control" id="name" name="name" placeholder="Automatic" type="text" required>
            <span id="name-text">Fuel</span>
            <input class="form-control" id="name" name="name" placeholder="Diesel" type="text" required>
            <span id="name-text">Capacity</span>
            <input class="form-control" id="name" name="name" placeholder="5 People" type="text" required>
